...
Konzeptionelle Grundlage dieser Anwendungen ist die des \emph{Termersetzungssystems}: Mit einer vom Nutzer oder Bibliotheksautor bestimmten Menge von Ersetzungsregeln wird ein gegebender Ausdruck so lange transformiert, bis keine Regel mehr anwendbar ist.
