...
\newtheorem{bspStarkGeordnet}[bsp]{Beispiel}
\begin{bspStarkGeordnet}~\\
...
\end{bspStarkGeordnet}


\newtheorem{lemStarkGeordnet}[bsp]{Lemma}
\begin{lemStarkGeordnet}~\\
...
\begin{lemTransitivStark}\label{lemTransitivStark}~\\
