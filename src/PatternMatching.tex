...
\If {$p \in X$ \textbf{and} $v_p~p = \bot$}{
    $(v_p~p) \leftarrow t$\;
    \Return {$(\mathrm{true}, v_p)$}
}
\ElseIf {$p \in X$ \textbf{and} $v_p~p \neq \bot$}{
    \Return {$(v_p~p = t, v_p)$}
}
\ElseIf {$p \in C \setminus X$} {
    \Return {$(p = t, v_p)$}
}
\ElseIf {$p = f(m_1, \dots, m_n)$ \textbf{and} $t = f(t_1, \dots, t_n)$}{
    \For {$k \in \{1, \dots, n\}$}{
        $(s_k, v_p) \leftarrow \mathrm{simpleMatchAlgorithm}(m_k, t_k, v_p)$\;
        \If {$\mathrm{not}~s_k$}{
...
Gibt es kein Match wird das Literal so lange indentisch abgelaufen, bis ein struktureller Unterschied festgestellt wurde. Dann bricht der Algorithmus ab.
\hfill $\square$\\
\end{bewNatchLinear}
...
\begin{equation*}
    ...
    \end{split}
\end{equation*}
Für die folgenden Algorithmen und auch in der echten Umsetzung ist es allerdings nicht praktikabel diese Definition anzuwenden, Multi-Mustervariablen werden dort also formal inkorrekt als einzelne Symbole in einem tatsächlichen Muster betrachtet. 
Die Ersetzungsregel für die erste Binomischen Formel wird damit zu
...
\BFred{TODO: Beweise $p \prec q$}

\newtheorem{defStaerkerGeordnet}[bsp]{Definition}
\begin{defStaerkerGeordnet}~\\
Gilt für zwei Muster $p_1, p_2 \in M(F, C)$, dass alle Literale $t_1, t_2 \in T(F, C)$ für die es jeweilige Matchfunktionen $v_{p_1}, v_{p_2} \colon X \rightarrow T(F, C)$ gibt, $t_1 \leq t_2$ erfüllen, so ist $p_1$ \emph{stark kleiner gleich} als $p_2$, geschrieben $p_1 \preceq p_2$.
\end{defStaerkerGeordnet}
...
Für Muster $p, q, r \in M$ mit $p \prec q \leq r$ folgt $p \prec r$ $(1)$. In die andere Richtung folgt zudem aus $p \leq q \prec r$ dass $p \prec r$.
\end{lemTransitivStark}

%.........................................................................
%.........................................................................
%.........................................................................
\subsection{Kommutative und beschränkt Assoziative Muster} \label{subsecACMuster}
